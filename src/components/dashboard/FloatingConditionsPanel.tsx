...
import { mockSensorData } from "@/lib/services/sensorData";
...
export default function FloatingConditionsPanel() {
  ...
  return (
    <div className="absolute top-[76px] right-[340px] z-30 w-[300px] flex flex-col" style={{ maxHeight: 'calc(100vh - 130px)' }}>
      {/* Header */}
      <div
