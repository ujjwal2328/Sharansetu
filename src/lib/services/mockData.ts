...
export const mockShelters: Shelter[] = [
  { id: 'shelter-1', name: 'Science College Camp', location: { lat: 21.2468, lng: 81.5950 }, total_capacity: 2000, current_occupancy: 1900, available_capacity: 100, facilities: ['Medical', 'Food', 'Water', 'Power Backup'], medical: { oxygen_tanks: 12, first_aid_kits: 40, nurses: 4, doctors: 2 }, status: 'NEAR_CAPACITY', accessibility_status: 'ACCESSIBLE' },
  { id: 'shelter-2', name: 'NIT Raipur Stadium', location: { lat: 21.2497, lng: 81.6050 }, total_capacity: 3500, current_occupancy: 600, available_capacity: 2900, facilities: ['Food', 'Water', 'Helipad'], medical: { oxygen_tanks: 25, first_aid_kits: 80, nurses: 8, doctors: 3 }, status: 'AVAILABLE', accessibility_status: 'ACCESSIBLE' },
  { id: 'shelter-3', name: 'Indoor Stadium, Budhapara', location: { lat: 21.2335, lng: 81.6318 }, total_capacity: 1500, current_occupancy: 1500, available_capacity: 0, facilities: ['Medical', 'Food'], medical: { oxygen_tanks: 6, first_aid_kits: 20, nurses: 2, doctors: 1 }, status: 'FULL', accessibility_status: 'PARTIALLY_ACCESSIBLE' },
  { id: 'shelter-4', name: 'Govt School, Pandri', location: { lat: 21.2610, lng: 81.6440 }, total_capacity: 800, current_occupancy: 200, available_capacity: 600, facilities: ['Water', 'Food'], medical: { oxygen_tanks: 3, first_aid_kits: 15, nurses: 1, doctors: 0 }, status: 'AVAILABLE', accessibility_status: 'ACCESSIBLE' },
  { id: 'shelter-5', name: 'Exhibition Center', location: { lat: 21.2395, lng: 81.6660 }, total_capacity: 2500, current_occupancy: 1200, available_capacity: 1300, facilities: ['Medical', 'Food', 'Water', 'Power Backup'], medical: { oxygen_tanks: 18, first_aid_kits: 60, nurses: 6, doctors: 2 }, status: 'AVAILABLE', accessibility_status: 'ACCESSIBLE' },
  { id: 'shelter-6', name: 'Community Hall, Bhatagaon', location: { lat: 21.2050, lng: 81.6200 }, total_capacity: 1200, current_occupancy: 1050, available_capacity: 150, facilities: ['Water'], medical: { oxygen_tanks: 2, first_aid_kits: 10, nurses: 1, doctors: 0 }, status: 'NEAR_CAPACITY', accessibility_status: 'ACCESSIBLE' }
];
